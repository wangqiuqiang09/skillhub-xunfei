...
export function LandingPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <main ref={heroView.ref} className={`relative z-10 flex flex-col items-center px-4 pb-12 pt-10 md:pb-14 md:pt-14 scroll-fade-up${heroView.inView ? ' in-view' : ''}`}>
        ...
        <p
          className="text-base md:text-lg text-center max-w-2xl mb-7 leading-relaxed"
