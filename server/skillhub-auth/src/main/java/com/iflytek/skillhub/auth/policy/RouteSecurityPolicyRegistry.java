...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/v1/skills/*/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/v1/skills/*/*/versions/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/v1/skills/*/*/tags/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/web/skills/*/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/web/skills/*/*/versions/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/web/skills/*/*/tags/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/cli/v1/skills/*/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.HEAD, "/api/cli/v1/skills/*/*/versions/*/download"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/skills/**"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/v1/skills/*/*/download"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/v1/skills/*/*/versions/*/download"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/v1/skills/*/*/tags/*/download"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skills"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skills/**"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/web/skills/*/*/download"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/web/skills/*/*/versions/*/download"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/web/skills/*/*/tags/*/download"),
            ...
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/cli/v1/skills/*/*/download"),
            ApiTokenPolicy.allow(HttpMethod.HEAD, "/api/cli/v1/skills/*/*/versions/*/download"),
